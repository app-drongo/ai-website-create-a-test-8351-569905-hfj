  ...
  const footerSections = [
    {
      title: 'Solutions',
      links: [
        { name: 'Cloud Migration', href: '/about' },
        { name: 'Infrastructure Management', href: '/about' },
        { name: 'Security Audits', href: '/about' },
        { name: 'DevOps Consulting', href: '/about' },
        { name: 'API Development', href: '/about' },
        { name: 'System Integration', href: '/about' },
      ],
    },
    {
      title: 'Company',
      links: [
        ...
        { name: 'Technology Partners', href: '/about' },
    ...
    },
    {
      title: 'Resources',
      links: [
        { name: 'Technical Documentation', href: '/about' },
        { name: 'Developer Community', href: '/about' },
        { name: 'Implementation Guides', href: '/about' },
        { name: 'Best Practices', href: '/about' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Data Processing', href: '/about' },
        { name: 'Compliance Standards', href: '/about' },
        { name: 'Security Framework', href: '/about' },
        { name: 'Audit Reports', href: '/about' },
      ],
    },
  ];
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Delivering enterprise-grade technology solutions and cloud infrastructure services.
                Trusted by Fortune 500 companies for mission-critical system implementations.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">enterprise@brand.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Phone className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">+1 (555) 847-2100</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Receive technical insights and infrastructure updates. Enterprise-focused content
                only.
              </p>
            </div>
          </div>
